...
class CardEmulationModule(
    ...
    private fun buildStateMap(): WritableMap = Arguments.createMap().apply {
        ...
        putBoolean(
            "hasPaymentRequest",
            CardEmulationState.hasPublishedPaymentRequest(reactApplicationContext)
        )
        ...
        putBoolean(
            ...
            CardEmulationState.hasPaymentAuthorization(reactApplicationContext)
        )
    }
